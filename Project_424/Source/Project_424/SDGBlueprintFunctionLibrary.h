...
#include "SDGBlueprintFunctionLibrary.generated.h"

/**
 * 
 */
UCLASS()
class PROJECT_424_API USDGBlueprintFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()

	/** Find quaternion between two vectors */
	UFUNCTION(BlueprintPure, meta = (ScriptMethod = "FindQuatBetween"), Category = "Math|Vector")
	static FQuat Vector_FindBetween(const FVector& A, const FVector& B);
