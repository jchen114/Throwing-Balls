...
#include "SDGBlueprintFunctionLibrary.h"
#include "Math/Quat.h"

FQuat USDGBlueprintFunctionLibrary::Vector_FindBetween(const FVector& A, const FVector& B)
{
	return FQuat::FindBetween(A, B);
}

// Formula to convert a Euler angle in degrees to a quaternion rotation
FQuat USDGBlueprintFunctionLibrary::Euler_To_Quaternion(FRotator Current_Rotation)
{
...
void USDGBlueprintFunctionLibrary::SetWorldRotationQuat(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
    if (SceneComponent)
    {
...
void USDGBlueprintFunctionLibrary::SetRelativeRotationQuat(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
    if (SceneComponent)
    {
...
void USDGBlueprintFunctionLibrary::AddLocalRotationQuat(USceneComponent* SceneComponent, const FQuat& Delta_Rotation)
{
    if (SceneComponent)
    {
...
void USDGBlueprintFunctionLibrary::SetActorWorldRotationQuat(AActor* Actor, const FQuat& Desired_Rotation)
{
    if (Actor)
    {
...
void USDGBlueprintFunctionLibrary::SetActorRelativeRotationQuat(AActor* Actor, const FQuat& Desired_Rotation)
{
    if (Actor)
    {
...
void USDGBlueprintFunctionLibrary::AddActorLocalRotationQuat(AActor* Actor, const FQuat& Delta_Rotation)
{
    if (Actor)
    {
